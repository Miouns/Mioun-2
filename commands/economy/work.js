...
exports.run = async (client, message, args) => {
    ...
    /* if (args[0] == 'prostitute') {
        ...
        .setDescription(`${message.author.name}, you worked as a prostitute & got payed ${amount}$ for having sex! :D`)
        .setColor("RANDOM")
        ...
        let embed = new Discord.RichEmbed()
        .setAuthor(`${message.author.tag}`, message.author.displayAvatarURL) 
        .setDescription(`${message.author.name}, you worked as a constructor & got payed ${amount}$ for rebuilding the empire state building.`)
        .setColor("RANDOM")
        ...
        let embed = new Discord.RichEmbed()
        .setAuthor(`${message.author.tag}`, message.author.displayAvatarURL) 
        .setDescription(`${message.author.name}, you worked as a programmer for epicgames, you fixed their game & earned ${amount}$!`)
        .setColor("RANDOM")
